...
const FBAuth =  (req, res, next) => {
  ...
  admin.auth().verifyIdToken(idToken)
    ...
    .then( data =>{
      ...
      return next(); // this will follow to the api call 
    })
    .catch(err => {
...
app.post('/login', (req, res) => {
  ...
  if(isEmpty(user.email)) errors.email = 'Must not be emoty';
  if(isEmpty(user.password)) errors.password = 'Must not be emoty';
